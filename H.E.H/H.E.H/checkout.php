...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark" style="background-color: #0d5492;">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <?php if(isset($user)): ?>
                <a href="#" class="nav-item nav-link"><i class="bi-cart"></i> Cart</a>
...
<div class="container">
  	<div class="p-5 my-4 bg-light rounded-3">
        ...
        <p class="text-center"> Thanks for shopping with us, <?= htmlspecialchars($user["username"]) ?>!</p>
        <hr>
        <div class="text-center">
        <p><a href="index.php"  class="btn btn-outline-primary bi-house-fill"><b> Return to the homepage</b></a></p>
</div>
