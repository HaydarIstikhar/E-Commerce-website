        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                ...
                <a href="product.php" class="nav-item nav-link"><i class="bi-search"></i> Product</a>
              	<a href="contact.php" class="nav-item nav-link active"><i class="bi-person-lines-fill"></i> Contact us</a>
            </div>
...
<div class="container">
  	<div class="p-5 my-4 bg-light rounded-3">
        ...
        <p class="lead"><b>Haydar Istikhar </b></p>
        <p2 class="lead">HaydarIstikhar@mail.bcu.ac.uk </p>
        <hr>
        <p class="lead"><b>Ellard Matinga </b></p>
        <p2 class="lead">ellard.matinga@mail.bcu.ac.uk </p>
        <hr>
        <p class="lead"><b>Haris Hussain </b></p>
        <p2 class="lead">haris.hussain3@mail.bcu.ac.uk </p>
        <hr>
</div>
</footer>
